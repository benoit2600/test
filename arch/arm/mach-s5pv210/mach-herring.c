...
#define SCREEN_FREQ			72 // 65fps on the device, dunno why
...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC0 (13312 * SZ_1K) // (10Mb 10240) (13MB 13312) 
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC1 (13312 * SZ_1K) // 10MB will work on Slim Bean
