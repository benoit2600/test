...
#define SCREEN_FREQ			70 // 65fps on the device, dunno why
...
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC0 (10240 * SZ_1K) // (11Mb 11264) (13MB 13312) 
#define  S5PV210_VIDEO_SAMSUNG_MEMSIZE_MFC1 (10240 * SZ_1K) // 11MB will work on Slim Bean
